...
<h1 align="center">Parametros de Calculo Mensual</h1>
<form>
<div class="row">
	<div class="col-md-6">
		<label>61.- Tipo de Mes: </label>
			<select>
				<option>1 Periodo Fijo Siempre 15dias</option>
				<option>2 Periodo Variable Diferente a 15 dias</option>
			</select><br>
		<label>62.-Factor Dias Pagados/Trabajados: </label>
			<input type="number" name="" step="0.0001" placeholder="0.000"><br>
		<label>63.-No. de Percepciones Fijas</label>
			<select>
		...
		<label>64.-No de Deducciones Fijas: </label>
			<select>
		...
		<label>65.-No Dias a Cotizar IMSS: </label>
				<input type="numbre" name="" placeholder="15">
	</div>
	<div class="col-md-6">
		<label>66.-Formas de Desc. ISPT: </label>
			<select>
		...
		<label>77.-Numero de tabla de ISPT: </label>
			<input type="number" name=""><br>
		<label>68.-Numero de Periodo: </label>
			<input type="number" name=""><br>
		<label>69.-Fecha Inicial: </label>
			<input type="date" name=""><br>
		<label>70.-Fecha Final: </label>
			<input type="date" name=""><br>
		<label>71.-No Dias a Pagar</label>
